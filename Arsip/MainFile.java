...
public class MainFile {
	...
	public void SaveToFile() { // menulis ke file
		...
		try {
			...
			out = new ObjectOutputStream(new FileOutputStream("D:\\" + "Nasabah.dat"));// nama direktori+file
	...
	public void ViewFile() {
		...
		try {
			...
			in = new ObjectInputStream(new FileInputStream("D:\\Nasabah.dat"));
	...
	public void ViewFile2() {
		...
		try {
			// 1. buka file untuk dibaca
			in = new ObjectInputStream(new FileInputStream("D:\\NasabahCopy.dat"));
			Object curR = in.readObject();
			try {
				// 2. baca dan proses setiap record yang dibaca
				while (true) {
